...
* If the project were a bit larger, I would consider adding end-to-end tests. Honestly the chained requests to different API endpoints are complex enough that it could benefit from them already.